...
def neg_elbo(x, samples, log_alphas_inf, log_alphas_gen, log=False):
...
def main(use_reinforce=True, relaxed=False, num_epochs=800,
         batch_size=24, num_latents=200, num_layers=2, lr=.0001):
    TRAIN_DIR = "./binary_vae_reinforce"
    ...
    f_b = neg_elbo(x, samples_b, inf_la_b, gen_la_b, log=True)
