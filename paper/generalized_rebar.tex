...
Training curves for all models can be seen in figure~\ref{fig:vae curves} and in appendix~\ref{extra vae results}.
...
%\includegraphics[width=.31\textwidth]{figures/OMNIGLOT_L2}\\
 \end{tabular}
\caption{Training curves for the one-layer VAE Experiments.
...
\newcommand{\rlfig}[1]{{\includegraphics[width=0.25\linewidth, clip, trim=3mm 3mm 3mm 3mm]{#1}}}
...
\includegraphics[width=.31\textwidth]{figures/OMNIGLOT_L2}
\end{tabular}
\caption{Training curves for VAE Experiments.
L1 represents the 1 layer linear model and L2 represents the 2 layer linear model.
The horizontal dashed line indicates the lowest validation error obtained by REBAR.}
\label{fig:vae curves 2}
\end{figure}
