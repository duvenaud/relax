...
However, if we were able to replace the $\PT \log p(z|\theta)$ in the control variate with $\PT \log p(b|\theta)$ we should be able to achieve a more correlated control variate. This is the motivation behind our next estimator, which we call RELAX.
