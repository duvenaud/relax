...
\setlength{\tabcolsep}{10pt}
\renewcommand{\arraystretch}{0}
\includegraphics[width=.30\linewidth]{figures/cp_paper} & 
\includegraphics[width=.29\linewidth]{figures/ll_paper} &
\includegraphics[width=.31\linewidth]{figures/ip_paper} & 
\includegraphics[width=.29\linewidth]{figures/idp_paper}\\
 \end{tabular}
...
\setlength{\tabcolsep}{10pt}
\renewcommand{\arraystretch}{0}
\includegraphics[width=.29\linewidth]{figures/cp_paper_var} & 
\includegraphics[width=.29\linewidth]{figures/ll_paper_var} &
\includegraphics[width=.29\linewidth]{figures/ip_paper_var} & 
\includegraphics[width=.27\linewidth]{figures/idp_paper_var}\\
 \end{tabular}
