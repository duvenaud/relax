...
%
In the reinforcement learning setting, our method could be combined with other variance-reduction techniques such as generalized advantage estimation~\citep{kimura2000analysis}, or other optimization methods, such as KFAC~\citep{wu2017scalable}.
