...
Discrete Structures are prevalent in nature and can often much more efficiently represent the semantic information in high dimensional input so tractable approaches to learning in model with discrete latent variables is very appealing. 
...
discrete sampling keeps us from applying reparamaterization gradients 

reinforce doesn?t get this info

pay homage to rebar

introduces conditional reparam

introduces gradient signal for minimizing variance
