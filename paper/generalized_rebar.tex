...
\begin{algorithm}[t]
\caption{Optimizing using \LAX{} for continuous inputs}
...
\While {not converged} 
	...
	\State  $g_phi \leftarrow 2 g_\theta \frac{\partial g_\theta}{\partial \phi}$ \Comment Estimate gradient of variance of gradient
	\State $\theta \leftarrow \theta + \alpha_1 g_theta$ \Comment Update parameters
	\State $\phi \leftarrow \phi + \alpha_2 g_phi$ \Comment Update control variate
\EndWhile
