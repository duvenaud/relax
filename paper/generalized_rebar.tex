...
We run experiments on some small reinforcement learning tasks with both discrete and continuous actions. We compare our method against a baseline of advantage actor-critic.
\begin{figure}[h]
\begin{center}
