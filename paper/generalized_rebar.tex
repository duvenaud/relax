...
\author{
  Will S. Grathwohl\thanks{Correspondence to Will Grathwohl}, Dami Choi, Yuhuai Wu, Geoff Roeder, David Duvenaud \\
...
We reproduced a subset of the experiments from \citet{tucker2017rebar}, training models with 1 or 2 layers of 200 Bernoulli random variables with linear or nonlinear mappings between them, on both  the MNIST and Omniglot~\citep{lake2015human} datasets.
