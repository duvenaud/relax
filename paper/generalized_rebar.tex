...
Thus, as before we have reduced the problem to that of estimating $\frac{\partial \mathbb{E}_{\tau}[f(\tau)]}{\partial \phi}$ which is the standard policy gradient algorithm~\citep{sutton2000policy}. 
