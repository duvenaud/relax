...
\caption{Histograms of samples from the 3 gradient estimators that create LAX. Samples generated from our 1 layer VAE experiments (Section \ref{vae section}).}
\end{figure}
%
\begin{align}
\label{eq:cont_est}
...
In parallel to our work, there has been a string of recent developments on action-dependent baselines for policy-gradient reinforcement learning such as \citet{gu2016q}, \citet{}, \citet{}. 
