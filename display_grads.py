...
with open('10k_mnist_vae_grad_samples.pkl') as f:
...
plt2.yaxis.set_label_coords(-0.22,0.4)
...
plt3.yaxis.set_label_coords(-0.2,0.4)
...
plt.xlabel('unbiased \nlow variance')
plt.ylabel('=', rotation=0, size=40)
plt4.yaxis.set_label_coords(-0.2,0.4)
plt.tight_layout()
