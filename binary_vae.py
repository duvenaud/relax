...
def main():
    ...
    tf.summary.histogram("z_der", d_f_z_d_log_alpha)
    tf.summary.histogram("z_tilde_der", d_f_z_tilde_d_log_alpha)
    ...
    gradvars = inf_gradvars + gen_gradvars + var_gradvars
    print("Inference")
    ...
    for i in range(250000):
        ...
        # re_var = reinforces.var(axis=0).mean()
        # rb_var = rebars.var(axis=0).mean()
        # print("rebar variance", rb_var)
        # print("reinforce variance", re_var)
        # print(rebars.mean(axis=0))
        # 1/0
